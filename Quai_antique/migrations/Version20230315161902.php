 ...
 */
final class Version20230315161902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carte ADD category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE carte ADD CONSTRAINT FK_BAD4FFFD12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('CREATE INDEX IDX_BAD4FFFD12469DE2 ON carte (category_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BAD4FFFD12469DE2 ON carte');
        $this->addSql('ALTER TABLE carte DROP category_id');
    }
}
